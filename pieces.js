...
function subtract_arrays(current_coordinates, ending_coordinates) {
...
function king_move_validation(startingPosition, endingPosition) {
    ...
    if (coordinates_difference[0] >= -1 && coordinates_difference[0] <= 1 && coordinates_difference[1] >= -1 && coordinates_difference[1] <= 1) {
        return true
    } else {
        return false
    }
...
function queen_move_validation(startingPosition, endingPosition) {
    let current_coordinates = find_coordinates(startingPosition)
    let ending_coordinates = find_coordinates(endingPosition)
    let coordinates_difference = subtract_arrays(current_coordinates, ending_coordinates)

    if (coordinates_difference[0] === 0 || coordinates_difference[1] === 0 || coordinates_difference[0] === -coordinates_difference[1] || coordinates_difference[0] === coordinates_difference[1]) {
        return true
    } else {
        return false
    }
...
function rook_move_validation(startingPosition, endingPosition) {
    let current_coordinates = find_coordinates(startingPosition)
    let ending_coordinates = find_coordinates(endingPosition)
    let coordinates_difference = subtract_arrays(current_coordinates, ending_coordinates)
...
function bishop_move_validation(startingPosition, endingPosition) {
    ...
    if (coordinates_difference[0] === coordinates_difference[1] || coordinates_difference[0] === -coordinates_difference[1]) {
        return true
    } else {
        return false
    }
...
function knight_move_validation(startingPosition, endingPosition) {
    let current_coordinates = find_coordinates(startingPosition)
    let ending_coordinates = find_coordinates(endingPosition)
    let coordinates_difference = subtract_arrays(current_coordinates, ending_coordinates)

    if (Math.abs(coordinates_difference[0]) === Math.abs(2 * coordinates_difference[1]) || Math.abs(2 * coordinates_difference[0]) === Math.abs(coordinates_difference[1])) {
        return true
    } else {
        return false
    }
